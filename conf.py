...
html_theme_options = {
    ...
    'navbar_title': "Приручник за 6. разред за пројектни задатак - Информационо комуникационе технологије",
...
html_title = 'Petlja - VI'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Petlja - VI'
